...
/**
 * This is the main background service which provides 2 inputs to the main activity
 * 1. Angle value (between -180 to +180) when ever there is a change of >45 degrees
 * 2. Number of steps whenever a new step is detected
 */
public class SensorService extends Service implements SensorEventListener{
    private static final String TAG = "com.example.fypprototype.SensorService";
    ...
    public static final String DIRECTION_UPDATE = TAG + ".action.DIRECTION_UPDATE";
    public static final String STEP_UPDATE = TAG + ".action.STEP_UPDATE";
    private Timer fuseTimer = new Timer();
    DecimalFormat d = new DecimalFormat("#.##");
    private int mStep = 0;
    public static Integer startAngle = null;
    ...
    class calculateFusedOrientationTask extends TimerTask {
        public void run() {
            ...
            double azimuth = fusedOrientation[0] * 180/Math.PI;
			/*double pitch = fusedOrientation[1] * 180/Math.PI;
			double roll= fusedOrientation[2] * 180/Math.PI;*/
			/*if(startAngle != null)
			startAngle = (int)azimuth;
			 */
            currentAngle = (int)azimuth;
            if(Math.abs((prevAngle+180) - (currentAngle+180)) > 45){
                announceChanges(DIRECTION_UPDATE);
    ...
    private void announceChanges(String type)
    {
        if(type.equals(STEP_UPDATE)){
            ...
            Intent intent = new Intent(DIRECTION_UPDATE);
